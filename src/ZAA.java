...
//        userAuth.register();
//        driverAuth.register();
        UserAccount user = (UserAccount) userAuth.login();
...
//        admin.listPendingDrivers();
        Area giza = Load.findArea("Giza");
        DriverAccount driver = (DriverAccount) driverAuth.login();
//        driver.addFavArea(giza);
        Ride ride = user.requestRide(giza, Load.findArea("Agouza"));
        System.out.println(driver.getNotifications());
        driver.makeOffer(20, ride);
